...
public class SoupdUpItems {
    ...
    public static final Item CHORUS_SOUP = registerItem("chorus_soup", new Item(new Item.Settings().food(SoupdUpFoodComponents.CHORUS_SOUP).useRemainder(BOWL).maxCount(1).registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(SoupdUp.MOD_ID,"chorus_soup")))));
