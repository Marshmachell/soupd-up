...
public class ModItems {
    ...
    public static final Item SEA_SOUP = registerItem("sea_soup", new Item(new Item.Settings().food(ModFoodComponents.SEA_SOUP, ModConsumableComponents.SEA_SOUP).useRemainder(BOWL).maxCount(1).registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(SoupdUp.MOD_ID,"sea_soup")))));
    public static final Item CHORUS_SOUP = registerItem("chorus_soup", new Item(new Item.Settings().food(ModFoodComponents.CHORUS_SOUP).useRemainder(BOWL).maxCount(1).registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(SoupdUp.MOD_ID,"chorus_soup")))));
